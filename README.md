...
| PyIQA | FR/NR | `musiq`, `brisque` | [IQA-Pytorch](https://github.com/chaofengc/IQA-PyTorch) | [Musiq](https://arxiv.org/abs/2108.05997) - [BRISQUE](https://ieeexplore.ieee.org/document/6272356) — image quality metrics provided as mean and per-frame scores (sampled at 2 per second). |
