...
def run_compressed_vqa_fr(ref, dist, output, multiscale=False, is_gpu=False):
    ...
    model_path = os.path.join(os.path.dirname(__file__), 'ckpts', 'UGCVQA_FR_model.pth')
...
if __name__ == '__main__':
    ...
    run_compressed_vqa_fr(config.ref, config.dist, config.output, config.multiscale, config.is_gpu)